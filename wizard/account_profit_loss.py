...
class AccountProfitLossReport(models.TransientModel):
    ...
    def _build_contexts(self, data):
        """
        Construction du contexte pour le rapport Profit and Loss
        """
        result = {}
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('base_accounting_kit_16.action_report_profit_loss').report_action(records, data=data)

    def check_report(self):
        """
        Surcharge de la méthode check_report pour générer le rapport Profit and Loss
        """
        self.ensure_one()
        data = {}
